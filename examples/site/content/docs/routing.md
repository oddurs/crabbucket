...
crab: 2 dead internal links:
  content/docs/routing.md: layout/ -> /docs/layout/ does not exist
  content/index.md: /crabbucket/faq/ -> /faq/ does not exist
```
...
Fragments *within* the site — `docs/routing/#link-checking` — have their
fragment stripped and the page checked. Verifying that the anchor itself
exists needs heading ids, which are not emitted yet.
